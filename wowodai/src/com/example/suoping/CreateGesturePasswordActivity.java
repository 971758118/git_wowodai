...
import com.example.suoping.LockPatternView.Cell;
import com.example.suoping.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lockpattern_gesturepassword_create);
		// 初始化演示动画
	...
	private void updatePreviewViews() {
		...
		for (LockPatternView.Cell cell : mChosenPattern) {
			...
			mPreviewViews[cell.getRow()][cell.getColumn()]
					.setBackgroundResource(R.drawable.lockpattern_gesture_create_grid_selected);
