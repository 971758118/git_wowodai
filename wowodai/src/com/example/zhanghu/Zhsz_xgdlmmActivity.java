...
public class Zhsz_xgdlmmActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zhsz_xgdlmm);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ok:
			...
			str_confirm = myMD5Util.getMD5Str(typeChange
					.editable2String(et_confirm.getText()));
			str_new = myMD5Util.getMD5Str(typeChange.editable2String(et_new
					.getText()));
			str_original = myMD5Util.getMD5Str(typeChange
					.editable2String(et_original.getText()));
			if (!str_new.equals(str_confirm)) {
